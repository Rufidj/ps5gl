...
TITLE_NAME=${TITLE_NAME:-libc catalog test}
...
echo ">>> compile"
$CC -c -O1 -Wall -Wextra -o "$out/main.o" "$here/main.c"

echo ">>> link"
"$PS5LINK/linker/link_real" "$out/app.elf" "$PS5LINK/linker/crt1_ps5.o" "$out/main.o" | tail -3
