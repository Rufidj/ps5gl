...
out=$here/out
TITLE_ID=${TITLE_ID:-PPSA00093}
TITLE_NAME=${TITLE_NAME:-PS5GL rendertarget}
...
echo ">>> compile"
$CC -c -O1 -Wall -Wextra -I"$here" -o "$out/main.o" "$here/main.c"
$CC -c -O1 -Wall -Wextra -I"$here" -o "$out/ps5gpu.o" "$here/ps5gpu.c"

echo ">>> link"
"$PS5LINK/linker/link_real" "$out/app.elf" "$PS5LINK/linker/crt1_ps5.o" "$out/main.o" "$out/ps5gpu.o" | tail -1
